			...
			<div class="inner">
				...
				<div class="header-lang">
					...
					<ul class="list">
						...
						<li><a href="vi/contactus.php"><span class="flag-icon flag-icon-vnm" style="padding: 0px;"></span><span class="code">VIETNAM</span> </a></li>
					</ul>
				</div>
		...
		<div class="container spot-metals">
			...
			<div class="visual">
				<div class="inner motion">
					<div class="visual-title ani-right delay10 neonText">CONTACT US</div>
			...
			<div class="content content-01">
				<div class="inner" style="width: 90%;">
					...
					<div class="content-color-text">
						Feel free to reach out dedicated customer service
					</div>
			...
			<div id="contact">
				<div class="email-us">
					<p class="contact-text2">Email Us</p>

					<a href="mailto:info@kj-glovicevc.com"><img class="icon-letter" src="img/aboutus/contactus/letter.png" alt="letter">Genenal Inquiry</a>
					<br>
					<a href="mailto:support@kj-glovicevc.com"><img class="icon-letter" src="img/aboutus/contactus/letter.png" alt="letter">Customer Support</a>
					<br>
					<!-- <a href="#"><img class="icon-letter" src="img/aboutus/contactus/letter.png" alt="letter">Backoffice</a> -->
				</div>
				<div class="our-com">
					<p class="contact-text2">Our Community</p>
