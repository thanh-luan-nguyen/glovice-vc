...
and wheat as CFDs and they are all with low spreads and leverage up to 1:100." />
	...
	<style>
		...
		.forex .visual {
			background-image: url(img/promotion/welcomebonus_visual_1.png);
...
<body>
	...
	<!-- allMenu -->
	<?php
	$link_switch = 'vi/welcomebonus.php';
			...
			<div class="inner">
				...
				<div class="header-lang">
					...
					<ul class="list">
						...
						<li><a href="vi/welcomebonus.php"><span class="flag-icon flag-icon-vnm" style="padding: 0px;"></span><span class="code">VIETNAM</span> </a></li>
					</ul>
				</div>
			</div>
		</div><!-- // header -->
		...
		<div class="container forex">
			...
			<div class="visual">
				<div class="inner motion">
					<div class="visual-title ani-right delay10 neonText">WELCOME<br>BONUS</div>
					<!-- <div class="visual-commodity-i1 ani-left delay2" style="height: 665px;"></div> -->
				</div>
			</div>
			<!-- // visual -->
			...
			<div class="content content-01">
				<div class="inner">
					<div class="content-color-text">
						<h3>Receive $30 and enjoy the best trading experience when coming to Glovice VC</h3>
					</div>
					<div class="content-color-image">
						<div class="content-image">
							<img src="img/promotion/welcome/newclient.png" alt="">
							<p>Available to all new Clients</p>
						</div>
						<div class="content-image">
							<img src="img/promotion/welcome/0r.png" alt="">
							<p>0 Trading Condition</p>
						</div>
						<div class="content-image">
							<img src="img/promotion/welcome/easy.png" alt="">
							<p>Earned Profits can be withdrawn easily</p>
						</div>
					</div>
				</div>
			</div><!-- // content -->
					...
					<div class="inner">
						<div class="content-info">
							<div class="content-info-part">
								...
								<div class="title">To benefit from the offer, follow the simple steps below:</div>
								<!-- <div class="main"> -->
								<div class="timeline">
									<h3>Don’t want to miss this incredible chance? </h3>
									<label>Follow the instructions below:</label>
									<div class="box">
										<div class="container">
											<div class="lines">
												<div class="dot"></div>
											...
											<div class="cards">
												<div class="card">
													<h4>STEP 1</h4>
													<p>Register a live trading account with Glovice VC</p>
												</div>
												<div class="card mid">
													<h4>STEP 2</h4>
													<p>Make at least a minimum deposit </p>
												</div>
												<div class="card">
													<h4>STEP 3</h4>
													<p>Automatically receive 30$ welcome bonus as your equity to trade </p>
												</div>
											</div>
										</div>
										<div class="bottom">
											<div class="btn">Get Your Bonus Now</div>
										</div>
									</div>
								</div>
							</div>
			...
			<!-- IMG content -->
			<div class="visual" style="background-image: url(img/promotion/content-welcomebonus-2.jpg);padding-top: 0px;padding-left: 0px;padding-bottom: 260px;background-size: cover;">
				<div class="inner motion">
